\makeatletter
\def\thebibliography#1{\section{Literaturverzeichnis\@mkboth
  {LITERATURVERZEICHNIS}{LITERATURVERZEICHNIS}}\list
...
\begin{thebibliography}{99}
    ...
    \bibitem{global-datasphere-estimate}
