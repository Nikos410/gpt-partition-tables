...
\begin{itemize}
    ...
    Dieses Limit wird allerdings nicht von allen Betriebssystemen unterstützt, beispielsweise können unter Linux aktuell maximal 256 Partionen auf einem Datenträger verwendet werden.\footnote{\url{https://git.kernel.org/pub/scm/linux/kernel/git/efi/efi.git/tree/include/linux/genhd.h?id=006405b324c071ebdcb5f6ebdc853edf8a8b7690} - Zeile 31}
