...
Wenn der Wert des Feldes \textit{sizeOfPartitionEntry} größer ist als die zuvor beschriebene Datenstruktur, muss der Rest des Partitions-Eintrags 0 sein und darf nicht anderweitig verwendet werden.\cite{uefi-spec}
